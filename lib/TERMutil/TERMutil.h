...
#define TERMutil_h
  ...
  #elif HAST_U8X8 == 1701 && DISPLAY_SIZE == 0x8040 && defined(DISPLAY_HW_SPI)
    #define TERMINAL_TYPE U8X8_UC1701_MINI12864_4W_HW_SPI     // HW SPI
  #elif HAST_U8X8 == 1701 && DISPLAY_SIZE == 0x8040 && defined(DISPLAY_H2_SPI)
  ...
  #elif HAST_U8X8 == 8544 && DISPLAY_SIZE == 0x5430 && defined(DISPLAY_HW_SPI)  // Nokia 5110 LCD
    #define TERMINAL_TYPE U8X8_PCD8544_84X48_4W_HW_SPI        // HW SPI
  #elif HAST_U8X8 == 8544 && DISPLAY_SIZE == 0x5430 && defined(DISPLAY_H2_SPI)  // Nokia 5110 LCD
